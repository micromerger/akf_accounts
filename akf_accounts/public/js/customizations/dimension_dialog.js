                ...
                if (row.__checked) {
                    ...
                    if ("funds_transfer_from" in frm.doc) {
                        ...
                        details.push({
                            ...
                            "pd_service_area": row.service_area,
                            "pd_subservice_area": row.subservice_area,
                            "pd_product": row.product,
                            "pd_project": row.project,
                            "pd_fund_class": row.fund_class,
                            "pd_donor_type": row.donor_type,
                            "pd_donor_desk": row.donor_desk,
                            "pd_intention": row.intention,
                            "pd_transaction_type": row.transaction_type,
                            "project": row.project,
                            "pd_donor": row.donor,
                            "encumbrance_project_account": row.encumbrance_project_account,
                            "encumbrance_material_request_account": row.encumbrance_material_request_account,
