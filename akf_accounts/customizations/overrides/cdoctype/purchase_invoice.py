...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		inter_branch_payable_account: DF.Link | None
		inter_branch_receivable_account: DF.Link | None
		...
		purchasing_branch: DF.Link | None
		purchasing_customer: DF.Link | None
		purchasing_supplier: DF.Link | None
		purchasing_supplier_name: DF.Data | None
		receiving_branch: DF.Link | None
		receiving_customer: DF.Link | None
		receiving_supplier: DF.Link | None
		receiving_supplier_name: DF.Data | None
