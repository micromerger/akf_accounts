...
class MaterialRequest(BuyingController):
	...
	if TYPE_CHECKING:
		from akf_accounts.akf_accounts.doctype.material_request_item.material_request_item import MaterialRequestItem
		from akf_accounts.akf_accounts.doctype.program_details.program_details import ProgramDetails
		...
		custom_encumbrance: DF.Check
		custom_program_details: DF.Table[ProgramDetails]
		...
		status: DF.Literal["", "Open", "Draft", "Submitted", "Stopped", "Cancelled", "Pending", "Partially Ordered", "Partially Received", "Ordered", "Issued", "Transferred", "Received"]
