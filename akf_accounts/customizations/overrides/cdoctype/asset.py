...
from akf_accounts.utils.asset_gle_entry.asset_inventory import make_asset_inventory_gl_entries
...
class Asset(AccountsController):
	...
	def on_submit(self):
		...
		make_asset_inventory_gl_entries(self) # Nabeel Saleem, 07-03-2025
