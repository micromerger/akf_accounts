...
class XAssetCapitalization(AssetCapitalization):
    def calculate_totals(self):
        ...
        custom_total = flt(self.custom_purchase_invoice_total or 0, self.precision("custom_purchase_invoice_total"))
        
        self.total_value += custom_total
...
def get_wip_composite_asset_se_items(target_asset):
    ...
    items = frappe.db.sql("""
        ...
        WHERE se_item.wip_composite_asset = %s
        AND se.docstatus = 1
